...
function SettingsContent() {
  ...
  const [billingStatus, setBillingStatus] = useState({ plan: "free", status: "active", subscription: null });
  ...
  useEffect(() => {
    ...
    ]).then(([profile, business, payments, stripeData, team, planData, billingStatusData, billingInvoiceData]) => {
      if (profile.user) {
