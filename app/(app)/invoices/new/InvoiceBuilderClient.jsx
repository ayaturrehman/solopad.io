            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              {services.length > 0 && (
                <div className="relative group">
                  <button className="inline-flex items-center gap-1.5 rounded border border-dashed border-zinc-300 px-3 py-1.5 text-xs font-medium text-zinc-500 hover:border-zinc-400 hover:text-zinc-700">
          ...
          <div className="rounded border border-zinc-200 bg-white p-6">
            ...
            <div className="mb-5 flex gap-2">
              <button
                ...
                className={`flex-1 rounded border py-2.5 text-sm font-medium transition-colors ${
                  paymentType === "lump_sum"
