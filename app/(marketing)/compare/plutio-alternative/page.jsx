export const metadata = {
  ...
  canonical: 'https://solopad.io/compare/plutio-alternative',
  openGraph: {
    title: 'Plutio Alternative for Freelancers | SoloPad',
    description: 'Compare Plutio vs SoloPad. Better pricing, no client limits, AI drafting, and simpler freelance management.',
    url: 'https://solopad.io/compare/plutio-alternative',
    type: 'article',
    images: [
      {
        url: 'https://solopad.io/og-plutio-comparison.png',
        width: 1200,
        height: 630,
  ...
  '@graph': [
    {
      ...
      description: 'Compare Plutio vs SoloPad. Better pricing, no client limits, AI drafting, and simpler freelance management.',
      image: 'https://solopad.io/og-plutio-comparison.png',
      author: {
        '@type': 'Organization',
        name: 'SoloPad',
    ...
    },
    {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: 'https://solopad.io/compare/plutio-alternative',
        },
      ],
    },
    {
